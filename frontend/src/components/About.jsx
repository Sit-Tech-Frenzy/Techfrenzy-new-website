...
const About = () => {
  ...
  return (
    ...
    >
      <div className='rounded-xl shadow-2xl p-8 sm:p-12 md:p-10 lg:p-20 mx-40 sm:mx-7 bg-gradient-to-tl from-opacity-10 to-transparent backdrop-blur-10 border border-opacity-18'>
        <h3 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-center mb-4 text-[#00df9a]'>About Us</h3>
        <hr className='bg-yellow-500 h-1 mt-6 mb-5' />
        <motion.p
          initial={{ x: '-100%' }}
          animate={{ x: 0 }}
          transition={{ duration: 0.5, delay: 0.3 }}
          className='text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-700 pt-5'
        >
